...
function Form() {
  ...
  return (
    <div className={style.background}>
      ...
      <div className={style.containerInputs}>
        <label className={style.label} id="email">Correo electrónico</label>
      ...
      <div className={style.containerInputs}>
        <label className={style.label} id="state">Departamento/Provincia</label>
        <input type="text" placeholder="Escribe tu departamento o provincia" />
      </div>

      <div className={style.containerInputs}>
        <label className={style.label} id="others">Otros</label>
      ...
      <div className={style.containerInputs}>
        <input type="submit" value="Confirmar datos de envío" id="sendDataButton"/>
      </div>
    </div>
  );
}
